export default {
  ...
  values:[['Persönliche Werte','Ehrlichkeit, Vertrauen, Initiative und Leistung. Wir streben nach größtmöglicher Wertschöpfung und verstehen dies als fortlaufenden Prozess. Charakter und tatsächlicher Beitrag zählen.'],['Werte im Team','Zusammenhalt, Energie, Lernen und Innovation. Wettbewerb, Anreize und leistungsbezogene Entscheidungen über den Verbleib im Team erhalten seinen Gestaltungswillen und seine Dynamik.'],['Unternehmerische Grundsätze','Differenzierung, Spezialisierung, eine führende Rolle und langfristiges Denken. Wir beurteilen jede Entscheidung mit weitem Zeithorizont und schaffen dauerhaften Wert für unsere Anspruchsgruppen.']],
  founderLabel:'Gründerin',founderTitle:'Shixi Lin',founderChinese:'林拾汐',founderRole:"Gründerin und Vorsitzende des Verwaltungsrats",founderAlt:"Porträt von Shixi Lin, Gründerin und Vorsitzende des Verwaltungsrats von Eleven Capital",founderLead:'Sie verbindet unternehmerische Einsicht mit einer humanistischen Perspektive und bringt Unternehmen, Talente und weltweite Chancen zusammen.',
  bio:['Shixi Lin verfügt über Erfahrung in Investment, Unternehmensinkubation und internationalem Handel. Sie war als Chief Executive Officer von drei Unternehmen tätig und bringt einen EMBA-Hintergrund mit. Besonderen Wert legt sie auf die strategische Positionierung von Marken und Unternehmen und nutzt Marktkenntnisse, um nachhaltiges Wachstum zu fördern.','Seit 2016 beschäftigt sie sich kontinuierlich mit den Möglichkeiten von Blockchain-Technologie und Web3. Ihr Augenmerk gilt der Verbindung von Web2- und Web3-Ökosystemen sowie der Verknüpfung neuer Technologien mit unternehmerischer Praxis.'],
  bioMore:['Knapp sieben Jahre Erfahrung im Bereich Psychologie haben ihre Fähigkeiten in Verhandlung und Ressourcenbündelung geprägt. In der Teamführung setzt sie auf Befähigung, Zusammenhalt und strategische Abstimmung. Gemeinsame Ziele und Ergebnisse sind ihr ebenso wichtig wie Anpassungsfähigkeit und das Verständnis neuer Entwicklungen.','Ihr Interesse an einer ganzheitlichen Sicht reicht bis zur Beschäftigung mit Esoterik und Theosophie. Auch Zen und daoistische Philosophie fließen in ihre Überlegungen zu Wirtschaft und Führung ein. Dabei sucht sie ein Gleichgewicht zwischen strategischem Urteil und philosophischer Tiefe.','Umfangreiche Reiseerfahrung und praktische Arbeit im internationalen Handel haben ihr ein interkulturelles Verständnis für globale Marktveränderungen und Branchentrends vermittelt. Sie baut funktionsübergreifende strategische Beziehungen auf, stimmt unterschiedliche Interessen ab und ermöglicht Kooperationen mit greifbaren Ergebnissen.'],
  bioSummary:'Ausführlicher Werdegang',partnerLabel:'Unsere Partner',partnerTitle:['Mit vielfältigen Partnern','gemeinsame Möglichkeiten erweitern'],partnerIntro:'Wir verbinden Ressourcen aus Technologie, Finanzwirtschaft und Industrie und fördern die Zusammenarbeit sich ergänzender Fachkompetenzen.',partnerText:'Mit internationalem Blick und branchenübergreifender Erfahrung unterstützen wir Markterschließung, Ressourcenbündelung und technische Erkundung. Jede Zusammenarbeit richten wir an konkreten Zielen und gemeinsamem Wachstum aus.',partnerLink:'Offizielle Website besuchen',
  contactTitle:['Gemeinsam weiter.','Den nächsten Schritt gestalten.'],contactText:'Teilen Sie uns Ihre Ziele, den aktuellen Stand und den gewünschten Zeitrahmen mit. Gemeinsam klären wir den nächsten Schritt.',legalName:'Eleven Capital Limited',copyright:'Alle Rechte vorbehalten.',backTop:'Nach oben',heroEyebrow:'Eleven Capital',
  pillars:[['technology','KI und Produktentwicklung'],['operations','Wartung und Weiterentwicklung'],['investment',"Gründungsbegleitung und Investorenkontakte"]],
  engagementLabel:'So arbeiten wir zusammen',engagementTitle:'Eine Übergabe kann der Beginn einer langfristigen Zusammenarbeit sein.',engagementIntro:'Sie können uns mit einem Entwicklungsprojekt beauftragen oder eine laufende Zusammenarbeit für Wartung und Weiterentwicklung vereinbaren. Anforderungen, Lieferumfang und anschließende Unterstützung klären wir von Anfang an.',
  engagementSteps:[['Anforderungen verstehen','Ziele, Einsatzszenarien und Prioritäten klären.'],['Entwerfen und entwickeln','Die Richtung am Prototyp prüfen und schrittweise liefern.'],['Bereitstellen und übergeben','Veröffentlichung, Dokumentation und Einweisung abschließen.'],['Warten und weiterentwickeln','Gemäß Vereinbarung Fehler beheben, optimieren und erweitern.']],
  projectCta:'Projekt besprechen',clientLabel:'Ein passender Einstieg',clientTitle:"Unterstützung für Ihren nächsten Schritt",clientIntro:"Ob Produkteinführung, effizientere Abläufe oder neue Märkte: Wir richten technische und unternehmerische Unterstützung an Ihren Zielen aus.", "homeAbout": "Eleven Capital mit Sitz in Hongkong verbindet Technologie, Branchenkompetenz und Kapital. Mit Produktentwicklung, Gründungsbegleitung, Kapitalstrategie und internationaler Zusammenarbeit unterstützen wir Unternehmen von der ersten Idee bis zum nachhaltigen Wachstum.",
  clients:[['Unternehmen und Marken mit Auslandsplänen','Ihre Website soll erneuert werden, oder Sie bereiten den Eintritt in einen neuen Markt vor.',"Eine mehrsprachige Website und klare Markeninhalte helfen internationalen Kunden, Ihr Angebot zu verstehen und Kontakt aufzunehmen.",'trade','Websites und internationales Geschäft'],['Start-ups und Produktteams','Die Produktrichtung steht, doch aus der Idee muss eine testbare Version werden.',"Von Anforderungen und Prototypen zur ersten Produktversion: Wir prüfen Kernfunktionen und entwickeln das Produkt anhand von Nutzerfeedback weiter.",'development','Anwendungs- und Produktentwicklung'],['Wachsende kleine und mittlere Unternehmen','Informationen sind verstreut; Recherche, Aufbereitung und Content-Arbeit kosten viel Zeit.',"Wissensassistenten und KI-Agenten reduzieren wiederkehrende Aufgaben im Arbeitsalltag; wichtige Schritte bleiben unter menschlicher Kontrolle.",'technology','KI und Prozessautomatisierung'],['Teams mit technischem Unterstützungsbedarf','Das Produkt ist bereits veröffentlicht, doch verlässliche Unterstützung bei Updates und Wartung fehlt.',"Wir prüfen bestehende Systeme und unterstützen ihren langfristigen Betrieb mit Fehlerbehebungen, Updates und funktionalen Erweiterungen.",'operations','Wartung und Weiterentwicklung']],
  ...
  ui:{home:'Startseite',more:'Mehr erfahren',services:'Alle Leistungen',about:'Über Eleven Capital',founder:'Unsere Gründerin',partners:'Unsere Partner kennenlernen'}
};
