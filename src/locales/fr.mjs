export default {
  lang:'fr',path:'/fr/',otherPath:'/',otherLabel:'EN',otherLang:'en',
  description:'Eleven Capital relie technologie et entreprise : agents IA, développement et maintenance de produits numériques, exploration du Web3 et du Web4, recherche en investissement, incubation et coopération internationale.',
  skip:'Aller au contenu',menu:'Menu',languageLabel:'Langue',nav:['À propos','Services','Fondatrice','Partenaires'],contact:'Nous contacter',
  heroLines:['IA et produits numériques.','Du développement à la maintenance à long terme.'],heroEnglish:'',
  heroIntro:'Nous développons des produits numériques et des agents IA pour les jeunes entreprises et les entreprises en croissance. De la concrétisation du projet à son exploitation continue, nous assurons un accompagnement technique à long terme.',
  ...
  values:[['Valeurs individuelles','Honnêteté, confiance, initiative et accomplissement. Nous recherchons la maximisation de la valeur dans un effort continu, en accordant de l’importance à l’intégrité personnelle et à la contribution réelle.'],['Valeurs collectives','Unité, énergie, apprentissage et innovation. Concurrence, incitations et maintien dans l’équipe fondé sur les résultats entretiennent son ambition et sa vitalité.'],['Philosophie de gestion','Différenciation, spécialisation, avance et vision à long terme. Nous évaluons chaque choix dans la durée pour créer une valeur pérenne pour les parties prenantes.']],
  founderLabel:'Fondatrice',founderTitle:'Shixi Lin',founderChinese:'林拾汐',founderRole:"Fondatrice et présidente du conseil d’administration",founderAlt:"Portrait professionnel de Shixi Lin, fondatrice et présidente du conseil d’administration d’Eleven Capital",founderLead:'Allier compréhension des affaires et regard humaniste pour relier entreprises, talents et opportunités à travers le monde.',
  bio:['Shixi Lin possède une expérience de l’investissement, de l’incubation d’entreprises et du commerce international. Elle a dirigé trois entreprises en qualité de directrice générale et dispose d’un parcours lié à l’EMBA. Elle accorde une place centrale au positionnement stratégique des marques et des entreprises, en s’appuyant sur sa compréhension des marchés pour soutenir une croissance durable.','Depuis 2016, elle explore les possibilités de la blockchain et du Web3, avec une attention particulière aux liens entre les écosystèmes Web2 et Web3 et à l’articulation entre technologies émergentes et pratique des affaires.'],
  bioMore:['Près de sept années d’expérience dans le domaine de la psychologie ont développé ses capacités de négociation et de coordination des ressources. Sa conception du management repose sur l’autonomisation, la cohésion et la coordination stratégique. Elle privilégie les objectifs et les résultats communs, tout en sachant s’adapter au changement et comprendre les nouvelles tendances.','Son intérêt pour une vision d’ensemble s’étend à l’étude de l’ésotérisme et de la théosophie. Elle intègre également le zen et la philosophie taoïste à sa réflexion sur les affaires et le management, à la recherche d’un équilibre entre jugement stratégique et profondeur philosophique.','Ses nombreux voyages et sa pratique du commerce international lui ont donné une compréhension interculturelle de l’évolution des marchés mondiaux et des tendances sectorielles. Elle sait établir des relations stratégiques entre fonctions, coordonner des parties prenantes diverses et favoriser des collaborations aux résultats concrets.'],
  bioSummary:'Parcours complet',partnerLabel:'Nos partenaires',partnerTitle:['Des partenaires divers.','Des possibilités partagées.'],partnerIntro:'Nous relions les ressources de la technologie, de la finance et des différents secteurs pour bâtir des collaborations entre expertises complémentaires.',partnerText:'Notre regard international et notre expérience de plusieurs secteurs soutiennent l’expansion commerciale, la mobilisation des ressources et l’exploration technique. Chaque collaboration s’inscrit dans des objectifs concrets et une croissance commune.',partnerLink:'Visiter le site officiel',
  contactTitle:['Avançons ensemble.','Préparons la suite.'],contactText:'Parlez-nous de vos objectifs, de l’avancement du projet et du calendrier souhaité. Définissons ensemble la prochaine étape.',legalName:'Eleven Capital Limited',copyright:'Tous droits réservés.',backTop:'Haut de page',heroEyebrow:'Eleven Capital',
  pillars:[['technology','IA et développement de produits'],['operations','Maintenance et amélioration continue'],['investment',"Incubation et mise en relation avec des investisseurs"]],
  engagementLabel:'Notre collaboration',engagementTitle:'Une livraison peut ouvrir la voie à une collaboration durable.',engagementIntro:'Vous pouvez nous confier un projet de développement ou établir une collaboration suivie pour la maintenance et les évolutions. Besoins, périmètre de livraison et accompagnement ultérieur sont clarifiés dès le départ.',
  engagementSteps:[['Comprendre les besoins','Clarifier les objectifs, les usages et les priorités.'],['Concevoir et développer','Valider la direction par un prototype et livrer par étapes.'],['Déployer et transmettre','Assurer la mise en ligne, la documentation et la prise en main.'],['Maintenir et faire évoluer','Corriger, optimiser et améliorer selon les modalités convenues.']],
  projectCta:'Parlons de votre projet',clientLabel:'Un point de départ pour collaborer',clientTitle:"Accompagner votre prochaine étape",clientIntro:"Lancement de produits, efficacité opérationnelle ou nouveaux marchés : nous adaptons notre soutien technique et commercial à vos objectifs.", "homeAbout": "Basée à Hong Kong, Eleven Capital relie technologie, industrie et capital. Développement de produits, incubation, stratégie de capital et coopération internationale soutiennent les entreprises de l’idée initiale à une croissance durable.",
  clients:[['Entreprises et marques à l’international','Votre site doit évoluer, ou vous préparez votre entrée sur un nouveau marché.',"Présentez clairement votre activité grâce à un site multilingue et à des contenus de marque qui facilitent la compréhension et la prise de contact des clients internationaux.",'trade','Sites et développement international'],['Jeunes entreprises et équipes produit','Vous avez une direction produit et devez transformer l’idée en une version à tester.',"Passez des besoins et du prototype à une première version, validez les fonctions essentielles et faites évoluer le produit à partir des retours des utilisateurs.",'development','Applications et produits'],['PME en croissance','Les informations sont dispersées ; recherche, organisation et contenu prennent beaucoup de temps.',"Intégrez assistants de connaissances et agents IA aux tâches quotidiennes pour réduire le travail répétitif, avec une validation humaine aux étapes clés.",'technology','IA et automatisation'],['Équipes en quête de soutien technique','Le produit est en ligne, mais il manque un accompagnement régulier pour les mises à jour et la maintenance.',"Nous évaluons les systèmes existants et assurons corrections, mises à jour et évolutions pour soutenir leur fonctionnement dans la durée.",'operations','Maintenance et évolutions']],
  ...
  ui:{home:'Accueil',more:'En savoir plus',services:'Tous nos services',about:'À propos d’Eleven Capital',founder:'Découvrir la fondatrice',partners:'Découvrir nos partenaires'}
};
