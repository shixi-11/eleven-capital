...
export const partners = [
  ...
  [
    "Solaire",
    "https://sn.solaireresort.com/gaming",
    "solaire",
    1113,
    620
  ]
...
export const content = {
  ...
  },
  {
    ...
    "engagementTitle": "一次交付，也可以是長期同行。",
    "engagementIntro": "可按項目委託開發，也可建立持續維護與迭代的合作。從需求、交付範圍到後續支持，先把每一步說清楚。",
    "engagementSteps": [
      [
        "理解需求",
        "釐清目標、場景與優先順序。"
  ...
  },
  {
    ...
    "engagementSteps": [
      [
        "Understand",
        "Define goals, use cases and priorities."
      ],
      [
        "Design & build",
        "Validate with prototypes and deliver in stages."
      ],
      [
        "Launch & hand over",
...
Object.assign(content, {ja, ko, es, fr, de, ar});
...
export const languages = [
  ...
  {lang:'es',path:'/es/',label:'Español',short:'ES'},
