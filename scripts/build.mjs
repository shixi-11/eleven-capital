...
<footer><p class="copyright"><span class="copyright-owner" dir="auto">© ${new Date().getFullYear()} ${c.legalName}${c.lang === "en" ? "." : ""}</span><span>${c.copyright}</span></p><a href="#top">${c.backTop}<span aria-hidden="true">↑</span></a></footer></body></html>`;
}
